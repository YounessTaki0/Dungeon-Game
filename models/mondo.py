...
room4 = Stanza(
    "The Infected Glass Conservatory",
...
room5 = Stanza(
    "The Ossuary of Eternal Silence",
...
room8 = Stanza(
    "The Cell of the Forgotten Prisoner",
...
if __name__ == "__main__":
    ...
    # Esponi la mappa popolata per l'importazione
    mappa = Stanze()
    mappa.aggiungi_stanze([room, room2, room3, room4, room5, room6, room7, room8, room9, room10])